...
void help(char *name) {
    ...
    fprintf(stderr, "       If this option is given then several group names can be given as\n");
    fprintf(stderr, "       argument and the program will filter out the graphs which have one\n");
    fprintf(stderr, "       of the specified groups as symmetry group.\n");
    ...
    fprintf(stderr, "       Dnd, Dnv   where n is either a positive integer or *\n");
    fprintf(stderr, "       Cs, Ci, T, Th, Td, O, Oh, I, Ih\n");
    fprintf(stderr, "    -i, --invert\n");
    fprintf(stderr, "       Inverts the filter, i.e., filter graphs not having one of the specified\n");
    fprintf(stderr, "       groups. This option has no effect if -f is not used.\n");
